...
RESOURCES += src/qt/zyte.qrc src/qt/zyte_locale.qrc

TRANSLATIONS += src/qt/locale/zyte_bg.ts \
                src/qt/locale/zyte_de.ts \
                src/qt/locale/zyte_en.ts \
                src/qt/locale/zyte_es.ts \
                src/qt/locale/zyte_fi.ts \
                src/qt/locale/zyte_fr.ts \
                src/qt/locale/zyte_it.ts \
                src/qt/locale/zyte_ja.ts \
                src/qt/locale/zyte_pl.ts \
                src/qt/locale/zyte_pt.ts \
                src/qt/locale/zyte_ru.ts \
                src/qt/locale/zyte_sk.ts \
                src/qt/locale/zyte_sv.ts \
                src/qt/locale/zyte_vi.ts \
                src/qt/locale/zyte_zh_CN.ts \
                src/qt/locale/zyte_zh_TW.ts
