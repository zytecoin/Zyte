                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("zyte Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a zyte address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zyte: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About zyte Core"), this);
    aboutAction->setStatusTip(tr("Show information about zyte Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for zyte"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your zyte addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified zyte addresses"));
    ...
    openAction->setStatusTip(tr("Open a zyte: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the zyte Core help message to get a list with possible zyte command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("zyte Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to zyte network", "", count));
}
...
{
    QString strTitle = tr("zyte Core"); // default title
