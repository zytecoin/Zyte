...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"zyte", "masternode", &masternode, true, true, false},
        {"zyte", "listmasternodes", &listmasternodes, true, true, false},
        {"zyte", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zyte", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zyte", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zyte", "masternodedebug", &masternodedebug, true, true, false},
        {"zyte", "startmasternode", &startmasternode, true, true, false},
        {"zyte", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zyte", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zyte", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zyte", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zyte", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zyte", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zyte", "mnbudget", &mnbudget, true, true, false},
        {"zyte", "preparebudget", &preparebudget, true, true, false},
        {"zyte", "submitbudget", &submitbudget, true, true, false},
        {"zyte", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zyte", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zyte", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zyte", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zyte", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zyte", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zyte", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zyte", "checkbudgets", &checkbudgets, true, true, false},
        {"zyte", "mnsync", &mnsync, true, true, false},
        {"zyte", "spork", &spork, true, true, false},
        {"zyte", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"zyte", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zyted, or the -server option to zyte-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zyte-cli " + methodname + " " + args + "\n";
}
