...
In order to support loading of multiple wallets in zyte-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zyte.cpp.
...
Changes to zyte.cpp
----------------------
zyte.cpp is the entry point into zyte-qt, and as such, will require some minor modifications to provide hooks for
