Contributing to zyte Core
============================

The zyte Core project operates an open contributor model where anyone is
...
The following applies to code changes to the zyte Core project, and is not to be
confused with overall zyte Network Protocol consensus changes.

Whether a pull request is merged into zyte Core rests with the project merge
...
Patches that change zyte consensus rules are considerably more involved than
...
Where a patch set proposes to change the zyte consensus, it must have been
...
The project leader is the release manager for each zyte Core release.
